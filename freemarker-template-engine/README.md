fluxnova-template-engines-freemarker  
===============================

<p>
  <a href="https://docs.camunda.org/manual/latest/">Fluxnova 1.0.0 Docs</a> |
...
You can use the template engine in Fluxnova Automation Platform 1.0.0 as scripting language.
