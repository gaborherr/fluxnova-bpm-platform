 ...
 */
package org.finos.fluxnova.bpm.run.example.invoice;

import jakarta.annotation.PostConstruct;
import org.finos.fluxnova.bpm.engine.ProcessEngine;
import org.finos.fluxnova.bpm.example.invoice.InvoiceApplicationHelper;
import org.finos.fluxnova.bpm.example.invoice.InvoiceProcessApplication;
...
@ConditionalOnProperty(name = "enabled", havingValue = "true", prefix = FluxnovaBpmProperties.PREFIX + ".run.example")
@Configuration
...
public class Application implements WebMvcConfigurer {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    ...
    registry.addResourceHandler("/fluxnova-invoice/**").addResourceLocations("classpath:/fluxnova-invoice/");
  }
