...
import org.finos.fluxnova.bpm.engine.variable.impl.context.EmptyVariableContext;
...
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BooleanValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BytesValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DateValueImpl;
...
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.LongValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.NumberValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.ShortValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.StringValueImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.builder.FileValueBuilderImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.builder.ObjectVariableBuilderImpl;
import org.finos.fluxnova.bpm.engine.variable.impl.value.builder.SerializedObjectValueBuilderImpl;
import org.finos.fluxnova.bpm.engine.variable.type.ValueType;
import org.finos.fluxnova.bpm.engine.variable.value.BooleanValue;
...
import org.finos.fluxnova.bpm.engine.variable.value.DoubleValue;
import org.finos.fluxnova.bpm.engine.variable.value.FileValue;
import org.finos.fluxnova.bpm.engine.variable.value.IntegerValue;
import org.finos.fluxnova.bpm.engine.variable.value.LongValue;
import org.finos.fluxnova.bpm.engine.variable.value.NumberValue;
import org.finos.fluxnova.bpm.engine.variable.value.ObjectValue;
import org.finos.fluxnova.bpm.engine.variable.value.SerializationDataFormat;
import org.finos.fluxnova.bpm.engine.variable.value.ShortValue;
...
import org.finos.fluxnova.bpm.engine.variable.value.builder.FileValueBuilder;
import org.finos.fluxnova.bpm.engine.variable.value.builder.ObjectValueBuilder;
import org.finos.fluxnova.bpm.engine.variable.value.builder.SerializedObjectValueBuilder;
import org.finos.fluxnova.bpm.engine.variable.value.builder.TypedValueBuilder;
