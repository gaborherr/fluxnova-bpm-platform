...
import org.finos.fluxnova.bpm.engine.telemetry.Database;
import org.finos.fluxnova.bpm.engine.telemetry.Internals;
import org.finos.fluxnova.bpm.engine.telemetry.Jdk;
import org.finos.fluxnova.bpm.engine.telemetry.Product;
...
public class TelemetryRestServiceTest extends AbstractRestServiceTest {
  ...
  public void shouldGetMinimalTelemetryData() {
    ...
    when(internals.getFluxnovaIntegration()).thenReturn(new HashSet<>());
