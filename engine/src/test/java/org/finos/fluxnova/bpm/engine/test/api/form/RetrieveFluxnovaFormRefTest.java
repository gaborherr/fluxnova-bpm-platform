...
public class RetrieveFluxnovaFormRefTest {
  ...
  public void shouldRetrieveTaskFormBindingLatestWithSingleVersionSeparateDeloyments() throws IOException {
    ...
    deployClasspathResources(true,
        "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingLatest.bpmn",
        "org/finos/fluxnova/bpm/engine/test/api/form/task.form");
    ...
    assertThat(IOUtils.toString(deployedForm, UTF_8)).isEqualTo(getClasspathResourceContent("org/finos/fluxnova/bpm/engine/test/api/form/task.form"));
  }
  ...
  public void shouldRetrieveTaskFormBindingLatestWithMultipleVersions() throws IOException {
    ...
    deployUpdateFormResource(TASK_FORM_CONTENT_V1, TASK_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingLatest.bpmn");
  ...
  public void shouldRetrieveTaskFormBindingDeployment() throws IOException {
    // given two versions of the same form
    deployUpdateFormResource(TASK_FORM_CONTENT_V1, TASK_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingDeployment.bpmn");
  ...
  public void shouldRetrieveTaskFormBindingVersionWithMultipleVersions() throws IOException {
    // given two versions of the same form
    deployUpdateFormResource(TASK_FORM_CONTENT_V1, TASK_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingVersion1.bpmn");
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingLatest.bpmn"})
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingDeployment.bpmn"})
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.taskFormBindingVersion2.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.form" })
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.shouldRetrieveTaskFormBindingLatestWithKeyExpression.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.form" })
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.shouldRetrieveTaskFormBindingVersionWithExpression.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.form" })
  ...
  public void shouldRetrieveStartFormBindingLatestWithSingleVersionSeparateDeloyments() throws IOException {
    // given two separate deployments
    deployClasspathResources(true,
        "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingLatest.bpmn",
        "org/finos/fluxnova/bpm/engine/test/api/form/start.form");
    ...
    assertThat(IOUtils.toString(deployedForm, UTF_8)).isEqualTo(getClasspathResourceContent("org/finos/fluxnova/bpm/engine/test/api/form/start.form"));
  }

  @Test
  public void shouldRetrieveStartFormBindingLatestWithMultipleVersions() throws IOException {
    // given two versions of the same form
    deployUpdateFormResource(START_FORM_CONTENT_V1, START_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingLatest.bpmn");
  ...
  public void shouldRetrieveStartFormBindingDeployment() throws IOException {
    // given two versions of the same form
    deployUpdateFormResource(START_FORM_CONTENT_V1, START_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingDeployment.bpmn");
  ...
  public void shouldRetrieveStartFormBindingVersionWithMultipleVersions() throws IOException {
    // given two versions of the same form
    deployUpdateFormResource(START_FORM_CONTENT_V1, START_FORM_CONTENT_V2, "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingVersion1.bpmn");
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingLatest.bpmn"})
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingDeployment.bpmn"})
  ...
  @Test
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/RetrieveCamundaFormRefTest.startFormBindingVersion2.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/form/start.form" })
  ...
  private void deployUpdateFormResource(String v1Content, String v2Content, String... additionalResourcesForFirstDeployment) throws IOException {
    ...
    form = FluxnovaFormUtils.writeTempFormFile("form.form", v1Content, tempFolder);
    ...
    form = FluxnovaFormUtils.writeTempFormFile("form.form", v2Content, tempFolder);
