...
import static org.finos.fluxnova.bpm.engine.delegate.TaskListener.EVENTNAME_DELETE;
import static org.finos.fluxnova.bpm.engine.impl.form.handler.DefaultFormHandler.FORM_REF_BINDING_VERSION;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.helper.BpmnExceptionHandler;
import org.finos.fluxnova.bpm.engine.impl.bpmn.helper.ErrorPropagationException;
import org.finos.fluxnova.bpm.engine.impl.bpmn.helper.EscalationHandler;
...
import org.finos.fluxnova.bpm.engine.impl.core.instance.CoreExecution;
import org.finos.fluxnova.bpm.engine.impl.core.variable.CoreVariableInstance;
import org.finos.fluxnova.bpm.engine.impl.core.variable.event.VariableEvent;
import org.finos.fluxnova.bpm.engine.impl.core.variable.scope.AbstractVariableScope;
import org.finos.fluxnova.bpm.engine.impl.core.variable.scope.VariableInstanceFactory;
import org.finos.fluxnova.bpm.engine.impl.core.variable.scope.VariableInstanceLifecycleListener;
import org.finos.fluxnova.bpm.engine.impl.core.variable.scope.VariableStore;
import org.finos.fluxnova.bpm.engine.impl.core.variable.scope.VariableStore.VariablesProvider;
...
import org.finos.fluxnova.bpm.engine.impl.interceptor.CommandContextListener;
import org.finos.fluxnova.bpm.engine.impl.interceptor.CommandInvocationContext;
...
import org.finos.fluxnova.bpm.engine.impl.task.delegate.TaskListenerInvocation;
    ...
    if(taskDefinitionKey != null) {
      ...
      if(taskDefinition != null) {
        ...
        if(formKey != null) {
          ...
          String formRefBinding = taskDefinition.getFluxnovaFormDefinitionBinding();
          Expression formRefVersion = taskDefinition.getFluxnovaFormDefinitionVersion();
