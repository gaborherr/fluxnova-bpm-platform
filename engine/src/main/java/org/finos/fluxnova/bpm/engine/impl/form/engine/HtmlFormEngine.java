 ...
 */
package org.finos.fluxnova.bpm.engine.impl.form.engine;
...
import org.finos.fluxnova.bpm.engine.form.FormFieldValidationConstraint;
...
import org.finos.fluxnova.bpm.engine.impl.form.type.EnumFormType;
...
public class HtmlFormEngine implements FormEngine {
  ...
  /* camunda attributes */
  protected static final String FXN_VARIABLE_TYPE_ATTRIBUTE = "fxn-variable-type";
  protected static final String FXN_VARIABLE_NAME_ATTRIBUTE = "fxn-variable-name";
  protected static final String FXN_SCRIPT_ATTRIBUTE = "fxn-script";
  protected static final String FXN_BUSINESS_KEY_ATTRIBUTE = "fxn-business-key";
  ...
  protected void addCommonFormFieldAttributes(FormField formField, HtmlElementWriter formControl) {
    ...
    if (!formField.isBusinessKey()) {
      formControl
          .attribute(FXN_VARIABLE_TYPE_ATTRIBUTE, typeName)
          .attribute(FXN_VARIABLE_NAME_ATTRIBUTE, formFieldId);
    }
    else {
      formControl.attribute(FXN_BUSINESS_KEY_ATTRIBUTE, null);
    }
