 ...
 */
package org.finos.fluxnova.bpm.container.impl.deployment;
...
import org.finos.fluxnova.bpm.container.impl.deployment.util.DeployedProcessArchive;
import org.finos.fluxnova.bpm.container.impl.metadata.PropertyHelper;
import org.finos.fluxnova.bpm.container.impl.spi.DeploymentOperation;
import org.finos.fluxnova.bpm.container.impl.spi.DeploymentOperationStep;
import org.finos.fluxnova.bpm.container.impl.spi.PlatformServiceContainer;
...
public class DeployProcessArchiveStep extends DeploymentOperationStep {
  ...
  public void performOperationStep(DeploymentOperation operationContext) {
    ...
    for (String processResource : listedProcessResources) {
      validateResourceName(processResource);
