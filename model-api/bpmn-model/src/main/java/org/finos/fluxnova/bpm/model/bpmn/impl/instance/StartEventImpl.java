...
import org.finos.fluxnova.bpm.model.bpmn.instance.CatchEvent;
...
public class StartEventImpl extends CatchEventImpl implements StartEvent {
   ...
   */
  @Deprecated
  public boolean isFluxnovaAsync() {
   ...
   */
  @Deprecated
  public void setFluxnovaAsync(boolean isCamundaAsync) {
  ...
  public void setFluxnovaInitiator(String camundaInitiator) {
