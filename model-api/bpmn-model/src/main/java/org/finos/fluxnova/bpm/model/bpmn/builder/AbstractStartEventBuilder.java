...
public abstract class AbstractStartEventBuilder<B extends AbstractStartEventBuilder<B>> extends AbstractCatchEventBuilder<B, StartEvent> {
   ...
   * @return the builder object
   */
  public B fluxnovaFormHandlerClass(String camundaFormHandlerClass) {
    element.setFluxnovaFormHandlerClass(camundaFormHandlerClass);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaInitiator(String camundaInitiator) {
    element.setFluxnovaInitiator(camundaInitiator);
    return myself;
  }
   ...
   * @return the builder object
   */
  public FluxnovaStartEventFormFieldBuilder fluxnovaFormField() {
    ...
    return new FluxnovaStartEventFormFieldBuilder(modelInstance, element, camundaFormField);
  }
