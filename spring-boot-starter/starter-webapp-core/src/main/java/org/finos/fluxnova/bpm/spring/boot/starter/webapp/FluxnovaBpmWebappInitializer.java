...
import org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.AppendTrailingSlashFilter;
import org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.LazyProcessEnginesFilter;
import org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.LazySecurityFilter;
import org.finos.fluxnova.bpm.tasklist.impl.web.TasklistApplication;
import org.finos.fluxnova.bpm.tasklist.impl.web.bootstrap.TasklistContainerBootstrap;
import org.finos.fluxnova.bpm.webapp.impl.engine.EngineRestApplication;
...
import org.finos.fluxnova.bpm.webapp.impl.security.filter.SessionCookieFilter;
import org.finos.fluxnova.bpm.webapp.impl.security.filter.headersec.HttpHeaderSecurityFilter;
import org.finos.fluxnova.bpm.webapp.impl.security.filter.util.HttpSessionMutexListener;
import org.finos.fluxnova.bpm.webapp.impl.util.ServletContextUtil;
import org.finos.fluxnova.bpm.welcome.impl.web.WelcomeApplication;
import org.finos.fluxnova.bpm.welcome.impl.web.bootstrap.WelcomeContainerBootstrap;
 ...
 */
public class FluxnovaBpmWebappInitializer implements ServletContextInitializer {

  private static final Logger log = LoggerFactory.getLogger(FluxnovaBpmWebappInitializer.class);
  ...
  public FluxnovaBpmWebappInitializer(FluxnovaBpmProperties properties) {
