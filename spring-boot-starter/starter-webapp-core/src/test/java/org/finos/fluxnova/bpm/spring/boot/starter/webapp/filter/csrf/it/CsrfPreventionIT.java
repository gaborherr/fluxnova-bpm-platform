 ...
 */
package org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.csrf.it;
...
public class CsrfPreventionIT {
  ...
  public void shouldSetCookieWebappRest() {
    httpClientRule.performRequest("http://localhost:" + port + "/fluxnova/api/engine/engine/");
  ...
  public void shouldRejectModifyingRequest() {
    ...
    URLConnection urlConnection = httpClientRule.performPostRequest("http://localhost:" + port +
            "/fluxnova/api/admin/auth/user/default/login/welcome", "Content-Type",
