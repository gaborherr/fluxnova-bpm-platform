# Fluxnova External Task Client as Spring Boot Starter

This project provides a Spring Boot Starter that allows you to implement an External Task Worker for Fluxnova. It uses the Fluxnova REST API to fetch, lock, and complete External Service Tasks. It is based on the [Java External Task Client](../../clients/java).
...
You can configure the Fluxnova Platform Runtime REST API endpoint and other properties in the `application.yml` file:
...
The Fluxnova External Task Client Spring Boot Starter project used to be a community extension initially created by [Oliver Steinhauer](https://github.com/osteinhauer).
