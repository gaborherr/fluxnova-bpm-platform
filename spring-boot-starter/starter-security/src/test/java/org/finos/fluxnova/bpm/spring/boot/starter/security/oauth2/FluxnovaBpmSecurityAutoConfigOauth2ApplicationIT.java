...
public class FluxnovaBpmSecurityAutoConfigOauth2ApplicationIT extends AbstractSpringSecurityIT {
  ...
  public void testSpringSecurityAutoConfigurationCorrectlySet() {
    ...
    assertThat(getBeanForClass(FluxnovaSpringSecurityOAuth2AutoConfiguration.class, mockMvc.getDispatcherServlet().getWebApplicationContext())).isNotNull();
    assertThat(getBeanForClass(FluxnovaBpmSpringSecurityDisableAutoConfiguration.class, mockMvc.getDispatcherServlet().getWebApplicationContext())).isNull();
  }
