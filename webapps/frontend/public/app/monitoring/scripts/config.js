...
export default {
  ...
  // },
  // customScripts: [
  //   // If you have a folder called 'my-custom-script' (in the 'monitoring' folder)
  ...
  //   paths: {
  //     // if you have a folder called `custom-ui` (in the `monitoring` folder)
  ...
  // bpmnJs: {
  //   moddleExtensions: {
  //     // if you have a folder called 'my-custom-moddle' (in the 'monitoring' folder)
  //     // with a file called 'camunda.json' in it defining the 'camunda' moddle extension
  //     camunda: 'my-custom-moddle/camunda'
  //   },
  //   additionalModules: [
  //     // if you have a folder called 'my-custom-module' (in the 'monitoring' folder)
