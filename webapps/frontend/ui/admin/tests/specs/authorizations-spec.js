...
describe('Admin Authorizations Spec', function() {
  function checkCreateNewState() {
    ...
    expect(authorizationsPage.createNewElement().isDisplayed()).to.eventually.be
      .true;
    expect(authorizationsPage.submitNewAuthorizationButton().isEnabled()).to
      .eventually.be.false;
  ...
  function checkAuthorizationTypes() {
    ...
    expect(authorizationsPage.identityIdInputFiled().isEnabled()).to.eventually
      .be.false;
    ...
    it('should validate authorization attributes', function() {
      authorizationsPage
        ...
        .then(function() {
          ...
          var permissionsList = ['READ', 'UPDATE', 'CREATE', 'DELETE'];
          checkPermissionTypes(permissionsList);
    ...
    it('should validate authorization attributes', function() {
      authorizationsPage
        ...
        .then(function() {
          ...
          var permissionsList = ['CREATE', 'READ', 'DELETE'];
          checkPermissionTypes(permissionsList);
    ...
    it('should validate authorization attributes', function() {
      authorizationsPage
        ...
        .then(function() {
          ...
          var permissionsList = ['READ', 'UPDATE', 'DELETE'];
          checkPermissionTypes(permissionsList);
    ...
    it('should validate authorization attributes', function() {
      authorizationsPage
        ...
        .then(function() {
          ...
          var permissionsList = ['CREATE', 'DELETE'];
          checkPermissionTypes(permissionsList);
    ...
    it('should validate authorization attributes', function() {
      authorizationsPage
        ...
        .then(function() {
          ...
          var permissionsList = ['CREATE', 'READ', 'UPDATE', 'DELETE'];
          checkPermissionTypes(permissionsList);
