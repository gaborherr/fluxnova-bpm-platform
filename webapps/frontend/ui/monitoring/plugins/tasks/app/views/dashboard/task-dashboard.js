...
module.exports = [
  ...
  function(ViewsProvider) {
    ViewsProvider.registerDefaultView('monitoring.tasks.dashboard', {
      id: 'task-dashboard',
      ...
      controller: [
        ...
        function(
          ...
          var HistoryResource = fxnAPI.resource('history'),
            TaskReportResource = fxnAPI.resource('task-report');
          ...
          var taskDashboardPlugins = Views.getProviders({
            component: 'monitoring.tasks.dashboard'
          });
