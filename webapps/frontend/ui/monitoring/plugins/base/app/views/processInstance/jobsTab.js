...
var Configuration = function PluginConfiguration(ViewsProvider) {
  ViewsProvider.registerDefaultView('monitoring.processInstance.runtime.tab', {
    id: 'jobs-tab',
    ...
    controller: [
      ...
      function(
        ...
        var jobProvider = fxnAPI.resource('job');
        var jobDefinitionProvider = fxnAPI.resource('job-definition');
