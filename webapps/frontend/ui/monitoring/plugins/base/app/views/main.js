...
var angular = require('angular'),
  fxnCommon = require('ui/common/scripts/module/index'),
...
var ngModule = angular.module('monitoring.plugin.base.views', [
  fxnCommon.name,
...
jobRetryBulkAction(ngModule, 'monitoring.processInstance.runtime.action');
