...
var ngModule = angular.module('fxn.monitoring.pages.processInstance', [
  fxnCommons.name,
  commonModule.name,
  'dataDepend'
]);
...
var Controller = [
  ...
  function(
    ...
    $scope.hasMigrationPlugin = isModuleAvailable(
    ...
    processData.provide('latestDefinition', [
      ...
      function(definition) {
        ...
        return fxnAPI.resource('process-definition').list(queryParams);
      }
    ]);
    ...
    processData.observe(
      ...
      function(processDefinition, processInstance, superProcessInstance) {
        ...
        var plugins = Views.getProviders({
          component: 'monitoring.processInstance.view'
        });
    ...
    $scope.processInstanceActions = Views.getProviders({
      component: 'monitoring.processInstance.runtime.action'
    });
    ...
    Data.instantiateProviders('monitoring.processInstance.data', {
      $scope: $scope,
    ...
    var instancePlugins = Views.getProviders({
      component: 'monitoring.processInstance.runtime.tab'
    })
      .concat(
        Views.getProviders({
          component: 'monitoring.processInstance.runtime.action'
      ...
      .concat(
        Views.getProviders({component: 'monitoring.processInstance.view'})
      )
      .concat(
        Views.getProviders({
          component: 'monitoring.processInstance.diagram.overlay'
        })
      );
...
var ViewConfig = [
  ...
  function(ViewsProvider) {
    ViewsProvider.registerDefaultView('monitoring.processInstance.view', {
      id: 'runtime',
      priority: 20,
