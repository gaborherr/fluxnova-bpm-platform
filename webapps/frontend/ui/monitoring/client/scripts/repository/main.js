...
var routes = require('./config/routes'),
  fxnMonitoringRepositoryViewCtrl = require('./controllers/fxn-monitoring-repository-view-ctrl'),
...
var deploymentModule = angular.module('fxn.monitoring.repository', ngDeps);

deploymentModule.config(routes);

deploymentModule.controller(
  'fxnMonitoringRepositoryViewCtrl',
  fxnMonitoringRepositoryViewCtrl
);
