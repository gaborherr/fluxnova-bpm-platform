...
var deleteDeploymentController = require('../fxn-monitoring-delete-deployment-modal-ctrl');
...
describe('monitoring.repository.deployment.action deleteDeployment modal controller', function() {
  var $controller;
  var $rootScope;
  var $q;
  var $scope;
  ...
  describe('deleteDeployment', () => {
    ...
    it('should perform delete deployment request', () => {
      ...
      expect(
        fxnAPI.delete.calledWith(deployment.id, {
          cascade: false,
