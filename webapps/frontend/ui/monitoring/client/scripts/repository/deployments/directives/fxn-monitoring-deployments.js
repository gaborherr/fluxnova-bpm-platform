...
var template = require('./fxn-monitoring-deployments.html?raw');
var searchConfigJSON = require('./fxn-monitoring-deployments-search-plugin-config.json');
  ...
  function() {
    return {
      ...
      controller: [
        ...
        'Notifications',
        'fxnAPI',
        function($scope, $location, $rootScope, search, Notifications, fxnAPI) {
          var Deployment = fxnAPI.resource('deployment');
