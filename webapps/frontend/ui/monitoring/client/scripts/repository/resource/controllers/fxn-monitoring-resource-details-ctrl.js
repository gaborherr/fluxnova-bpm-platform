...
module.exports = [
  ...
  'Views',
  '$translate',
  function($scope, $q, Uri, fxnAPI, Views, $translate) {
    // utilities ///////////////////////////////////////////////////
    ...
    var PLUGIN_ACTION_COMPONENT = 'monitoring.repository.resource.action';
    ...
    var ProcessDefinition = fxnAPI.resource('process-definition');
    var CaseDefinition = fxnAPI.resource('case-definition');
    var DecisionDefinition = fxnAPI.resource('decision-definition');
