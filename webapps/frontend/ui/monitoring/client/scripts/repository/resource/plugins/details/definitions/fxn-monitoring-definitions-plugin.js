...
var template = require('./fxn-monitoring-definitions-plugin.html?raw');
...
var Controller = [
  ...
  'fxnAPI',
  'hasPlugin',
  function($scope, $q, fxnAPI, hasPlugin) {
    // fields //////////////////////////////////////////////////////
    ...
    var ProcessInstance = fxnAPI.resource('process-instance');
    var CaseInstance = fxnAPI.resource('case-instance');
    var DrdService = fxnAPI.resource('drd');

    var resource;

    $scope.hasCasePlugin = hasPlugin(
      'monitoring.cases.dashboard',
      'case-definition'
    );
    $scope.hasDrdPlugin = hasPlugin(
      'monitoring.drd.definition.tab',
...
var Configuration = function PluginConfiguration(ViewsProvider) {
  ViewsProvider.registerDefaultView('monitoring.repository.resource.detail', {
    id: 'resource-details',
    template: template,
