...
var directivesModule = angular.module('fxn.monitoring.directives', [
  fxnCommon.name
]);
...
directivesModule.directive('fxnSelectActivity', selectActivity);
directivesModule.directive('fxnPieChart', pieChart);
directivesModule.directive('fxnSelectActivityInstance', selectActivityInstance);
directivesModule.directive('processVariable', processVariable);
directivesModule.directive('fxnDynamicName', dynamicName);
directivesModule.directive('fxnQuickFilter', quickFilter);
