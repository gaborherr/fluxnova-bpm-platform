...
describe('Monitoring Decision Definition Spec', function() {
    ...
    it('should go to decision definition view', function() {
      ...
      decisionsPage.deployedDecisionsList
        ...
        .then(function(decisionName) {
          ...
          // then
          expect(definitionPage.information.definitionName()).to.eventually.eql(
            decisionName
          );
        });
    });
  ...
  describe('instance list', function() {
    ...
    it('should display a list of evaluated decision instances', function() {
      expect(
        definitionPage.decisionInstancesTab.table().count()
      ).to.eventually.eql(1);
    });
  ...
  describe('table interaction', function() {
    ...
    it('should display decision table', function() {
      // then
      expect(definitionPage.table.tableElement().isDisplayed()).to.eventually.be
        .true;
    });
  });
  ...
  describe('search widget', function() {
    ...
    it('should add new filter', function() {
      ...
      //then
      var searchPillsCount = definitionPage.search.searchPills().count();
    ...
    it('should empty table when non existing value is chosen', function() {
      ...
      //then
      var tableRowsCount = definitionPage.decisionInstancesTab
        .table()
        .all(by.css('tbody > tr'))
        .count();
    ...
    it('should have after and before operators for Evaluated Date filter', function() {
      //given
      definitionPage.search.createSearch('Evaluated Date');

      //when
      definitionPage.search
        .searchPills()
        .last()
  ...
  describe('version interaction', function() {
    ...
    it('should display the most recent version initially', function() {
      expect(
        definitionPage.information.definitionVersionDropdownButtonText()
      ).to.eventually.eql('2');
    });
    ...
    it('should list all available versions', function() {
      ...
      // then
      expect(
        definitionPage.information.definitionVersionDropdownOptions().count()
      ).to.eventually.eql(2);
    });
    ...
    it('should load the requested version on selection', function() {
      ...
      definitionPage.information
        .definitionVersionDropdownOptions()
        .get(0)
        .click();
