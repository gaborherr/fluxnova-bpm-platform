...
var debugDefinition = require('../fxn-widget-debug');

var debugModule = angular.module('debugModule', []);
debugModule.directive('fxnWidgetDebug', debugDefinition);

var clipboardWidget = require('../../clipboard/fxn-widget-clipboard');
debugModule.directive('fxnWidgetClipboard', clipboardWidget);
