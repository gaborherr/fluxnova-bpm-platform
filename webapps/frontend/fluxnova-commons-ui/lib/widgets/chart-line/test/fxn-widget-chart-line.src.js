...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  fs = require('fs'),
  moment = require('fluxnova-bpm-sdk-js/vendor/moment'),
  data = {},
  chartLineDefinition = require('../fxn-widget-chart-line');
...
chartLineModule.directive('fxnWidgetChartLine', chartLineDefinition);
