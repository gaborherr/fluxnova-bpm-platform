...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  variableDefinition = require('../fxn-widget-variable'),
  variableValidator = require('../fxn-variable-validator');
...
variableModule.directive('fxnWidgetVariable', variableDefinition);
variableModule.directive('fxnVariableValidator', variableValidator);
...
testModule.controller('example3Controller', [
  '$scope',
  function($scope) {
