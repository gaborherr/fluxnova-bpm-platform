...
Example.prototype.inputDropdown = function() {
  return this.node.element(by.css('[fxn-widget-search] .form-container > ul'));
};
...
Example.prototype.searchPills = function() {
  return this.node.all(by.css('[fxn-widget-search] [fxn-widget-search-pill]'));
};
...
module.exports.FxnWidgetSearch = Example;
