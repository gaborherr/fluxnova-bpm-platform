...
Common frontend / UI resources, widgets and libraries for the [Fluxnova web application][webapp]:
...
Widgets are reusable components which should be easy to integrate in the [Fluxnova webapp][webapp] and your own projects.
...
- `fxn-widget-bpmn-viewer`
- `fxn-widget-cmmn-viewer`
- `fxn-widget-dmn-viewer`
- `fxn-widget-debug`
- `fxn-widget-footer`
- `fxn-widget-header`
- `fxn-widget-inline-field`
- `fxn-widget-loader`
- `fxn-widget-chart-line`
- `fxn-widget-search`
- `fxn-widget-search-pill`
- `fxn-widget-variable`
- `fxn-widget-variables-table`
- `fxn-widget-clipboard`
- `fxn-widget-var-template`
...
This will only run the `fxn-widget-variable` tests.
...
```
vim /fluxnova-commons-ui/node_modules/protractor/bin/webdriver-manager
```

Run chrome update for protractor

```
fluxnova-commons-ui/node_modules/protractor/bin/webdriver-manager --chrome update
```
...
[webapp]: https://github.com/finos/fluxnova-bpm-platform/tree/main/webapps
