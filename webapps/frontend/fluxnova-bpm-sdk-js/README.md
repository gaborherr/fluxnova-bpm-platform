...
Javascript client library for [Fluxnova Platform](https://github.com/finos/fluxnova-bpm-platform)
...
This will update the version, commit and tag it, then publish it to [bower-fluxnova-bpm-sdk-js] ** Needs To Be Reviewed ** (https://github.com/camunda/bower-camunda-bpm-sdk-js)

### Snapshot

To create a snapshot release which just builds current head and publishes it to [bower-fluxnova-bpm-sdk-js] ** Needs To Be Reviewed ** (https://github.com/camunda/bower-camunda-bpm-sdk-js) on a branch named the current version:
...
here](https://github.com/finos/fluxnova-bpm-platform/blob/main/CONTRIBUTING.md).
