...
describe('The input field', function() {
  ...
  var InputFieldHandler = FxnSDK.Form.fields.InputFieldHandler;
  ...
  it('should init the var type', function() {
    ...
    // an input field with 'fxn-variable-name' and 'fxn-variable-type' directive
