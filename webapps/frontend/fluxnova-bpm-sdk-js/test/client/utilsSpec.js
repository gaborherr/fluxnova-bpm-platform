  ...
  describe('HAL tools', function() {
    describe('solveHALEmbedded()', function() {
      ...
      it('remap the response object', function() {
        ...
        expect(remapped._embedded.objB[0]._embedded.objA[0].id).to.eql(
          remapped._embedded.objB[0].objAId
        );

        expect(remapped._embedded.objB[1]._embedded.objA[0].id).to.eql(
          remapped._embedded.objB[1].objAId
        );

        expect(remapped._embedded.objB[2]._embedded.objA[0].id).to.eql(
          remapped._embedded.objB[2].objAId
        );
      });
    });
  });
