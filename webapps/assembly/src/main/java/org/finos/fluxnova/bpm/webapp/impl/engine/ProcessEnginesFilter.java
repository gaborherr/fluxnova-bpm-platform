...
import org.finos.fluxnova.bpm.tasklist.TasklistRuntimeDelegate;
import org.finos.fluxnova.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider;
...
import org.finos.fluxnova.bpm.webapp.impl.filter.AbstractTemplateFilter;
import org.finos.fluxnova.bpm.webapp.impl.security.SecurityActions;
import org.finos.fluxnova.bpm.webapp.impl.security.SecurityActions.SecurityAction;
import org.finos.fluxnova.bpm.webapp.plugin.spi.AppPlugin;
import org.finos.fluxnova.bpm.welcome.Welcome;
import org.finos.fluxnova.bpm.welcome.WelcomeRuntimeDelegate;
...
public class ProcessEnginesFilter extends AbstractTemplateFilter {
  ...
  protected String getDefaultEngineName() {
    ...
    if(processEngineNames.isEmpty()) {
      throw new IllegalWebAppConfigurationException("No process engine found. Fluxnova Webapp cannot work without a process engine. ");
