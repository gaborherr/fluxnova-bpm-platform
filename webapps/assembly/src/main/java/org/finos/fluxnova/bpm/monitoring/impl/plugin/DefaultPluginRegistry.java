...
public class DefaultPluginRegistry implements PluginRegistry {
  ...
  private AppPluginRegistry<MonitoringPlugin> wrappedRegistry;

  public DefaultPluginRegistry(AppPluginRegistry<MonitoringPlugin> wrappedRegistry) {
    this.wrappedRegistry = wrappedRegistry;
  }

  public List<MonitoringPlugin> getPlugins() {
    return wrappedRegistry.getPlugins();
  }

  public MonitoringPlugin getPlugin(String id) {
