 ...
 */
package org.finos.fluxnova.bpm.monitoring.dto;
...
import org.finos.fluxnova.bpm.engine.rest.dto.converter.StringToTypeConverter;
...
public abstract class AbstractRestQueryParametersDto<T> extends QueryParameters {
  ...
  /**
   * Finds the methods that are annotated with a {@link FluxnovaQueryParam} with a value that matches the key parameter.
