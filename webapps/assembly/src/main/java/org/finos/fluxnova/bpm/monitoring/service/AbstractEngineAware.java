 ...
 */
package org.finos.fluxnova.bpm.monitoring.service;
 ...
 * the engine for which monitoring services should be provided.
 *
...
public class AbstractEngineAware {
  ...
  protected ProcessEngine getProcessEngine() {
    return Monitoring.getProcessEngine(engineName);
  }
}
