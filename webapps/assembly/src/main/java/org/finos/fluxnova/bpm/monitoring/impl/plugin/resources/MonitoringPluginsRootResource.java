 ...
 */
@Path("plugin/" + MonitoringPlugins.ID)
public class MonitoringPluginsRootResource extends AbstractMonitoringPluginRootResource {

  public MonitoringPluginsRootResource() {
    super(MonitoringPlugins.ID);
  }
