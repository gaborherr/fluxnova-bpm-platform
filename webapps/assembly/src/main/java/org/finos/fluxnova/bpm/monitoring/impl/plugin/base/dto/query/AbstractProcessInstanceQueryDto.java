...
import org.finos.fluxnova.bpm.engine.impl.QueryVariableValue;
...
import org.finos.fluxnova.bpm.engine.rest.dto.ConditionQueryParameterDto;
...
public abstract class AbstractProcessInstanceQueryDto<T extends ProcessInstanceDto>
  ...
  @FluxnovaQueryParam(value="processDefinitionId")
  ...
  @FluxnovaQueryParam(value="parentProcessDefinitionId")
  ...
  @FluxnovaQueryParam(value = "variables", converter = VariableListConverter.class)
  ...
  @FluxnovaQueryParam(value="parentProcessInstanceId")
  ...
  @FluxnovaQueryParam(value="activityIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value="businessKey")
  ...
  @FluxnovaQueryParam(value="startedBefore", converter = DateConverter.class)
  ...
  @FluxnovaQueryParam(value="startedAfter", converter = DateConverter.class)
  ...
  @FluxnovaQueryParam(value="withIncident", converter = BooleanConverter.class)
