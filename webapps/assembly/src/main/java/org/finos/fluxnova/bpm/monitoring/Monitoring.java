 ...
 */
package org.finos.fluxnova.bpm.monitoring;
...
/**
 * <p>Provides access to the camunda monitoring core services.</p>
 *
...
public class Monitoring {
   ...
   * initialized by bootstrapping camunda monitoring with an specific
   * instance
   */
  protected static MonitoringRuntimeDelegate MONITORING_RUNTIME_DELEGATE;
   ...
   * @return
   */
  public static MonitoringRuntimeDelegate getRuntimeDelegate() {
    return MONITORING_RUNTIME_DELEGATE;
  }

  /**
   * A setter to set the {@link CockpitRuntimeDelegate}.
   * @param monitoringRuntimeDelegate
   */
  public static void setMonitoringRuntimeDelegate(MonitoringRuntimeDelegate monitoringRuntimeDelegate) {
    MONITORING_RUNTIME_DELEGATE = monitoringRuntimeDelegate;
  }
