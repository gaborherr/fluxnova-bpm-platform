...
import static org.finos.fluxnova.bpm.engine.authorization.Permissions.ACCESS;
import static org.finos.fluxnova.bpm.engine.authorization.Resources.APPLICATION;
import static org.finos.fluxnova.bpm.webapp.impl.security.filter.util.HttpSessionMutexListener.AUTH_TIME_SESSION_MUTEX;
...
import org.finos.fluxnova.bpm.webapp.impl.WebappLogger;
...
public class AuthenticationUtil {
  ...
  public static Authentications getAuthsFromSession(HttpSession session) {
    Authentications authentications = (Authentications) session.getAttribute(FXN_AUTH_SESSION_KEY);
    if (authentications == null) {
      authentications = new Authentications();
      session.setAttribute(FXN_AUTH_SESSION_KEY, authentications);
    }
