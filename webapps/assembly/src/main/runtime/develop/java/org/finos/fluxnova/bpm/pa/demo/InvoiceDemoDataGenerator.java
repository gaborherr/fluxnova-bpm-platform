 ...
 */
package org.finos.fluxnova.bpm.pa.demo;
...
public class InvoiceDemoDataGenerator {
    ...
    public void createDemoData(ProcessEngine engine) {
      ...
      user.setEmail("demo@fluxnova.org");
      ...
      user2.setEmail("john@fluxnova.org");
      ...
      user3.setEmail("mary@fluxnova.org");
      ...
      user4.setEmail("peter@fluxnova.org");
