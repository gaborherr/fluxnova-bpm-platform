 ...
 */
public class PluginQueryTest extends AbstractMonitoringPluginTest {

  @Test
  public void testCustomQuery() {

    List<Execution> result = getQueryService().executeQuery("monitoring.base.selectProcessDefinitionWithFailedJobs", new QueryParameters());
